...
ggplot(data = Speed.df, aes(dummy.speed,
                            PredProb.Speed))+
  ...
  geom_text(label="Increase of 10 km/h = ~ 4% increase in collision probability",
            size=6,
            x=50,y=0.45)
...
ggplot(data = SPD_FULL.df)+
  geom_line(aes(dummy.ForDist,
                zPredProb.DistFor.Spd80),
            color="turquoise4",
            linewidth=1.1)+
  geom_line(aes(dummy.ForDist,
...
ggplot(data = HighSpeedCover)+
  geom_bar(aes(CoverProp,
               fill=CoverCat))
...
ggplot(data = HighSpeedCover, aes(y=CoverProp, fill=CoverCat))+
  geom_()
