...
SpdDistFor_Eqn <- function(x,z){
  SPD.c_FULL_INX$coefficients[1]+
    ...
    (SepSPD.f_FULL_INX$coefficients[3]*x)+  #zDFR
    (SepSPD.f_FULL_INX$coefficients[4]*mean(RoeDeer.df$zEFF))+  #zEFF
    (SepSPD.f_FULL_INX$coefficients[5]*mean(RoeDeer.df$zADT))+  #zADT
    (SepSPD.f_FULL_INX$coefficients[6]*mean(RoeDeer.df$zWAT))+  #ZWAT
    (SepSPD.f_FULL_INX$coefficients[7]*(z*x)) #speed*zDFR
}
